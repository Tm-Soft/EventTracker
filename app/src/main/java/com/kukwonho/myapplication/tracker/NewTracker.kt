...
class FirebaseLogStrategy(
    ...
    override fun sendEvent(message: String) = firebaseLog.sendEvent(message)
...
class ChannelTalkStrategy(
    ...
    override fun sendEvent(message: String) = channelTalk.sendEvent(message)
...
class AppsFlyerStrategy(
    ...
    override fun sendEvent(message: String) = appsFlyer.sendEvent(message)
